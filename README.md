...
| Ondertitelregels (Caption Boost) | 2 regels | Aantal regels in het caption-venster (1 of 2). Is de cue langer, dan schuift de tekst regel voor regel omhoog (zoals YouTube's auto-generated ondertitels); het font krimpt nooit |
...
* de hele cue staat **vooraf vast**: alle woorden krijgen hun plek, het eerste woord blijft **links uitgelijnd** staan en de rest schuift niet op; de tekst begint **linksboven in de balk** en gebruikt de **volle balkbreedte**. De balk is 80% van de spelerbreedte en staat gecentreerd (links en rechts blijft de video zichtbaar — geen balk van rand tot rand) en is een **venster van max. 1 of 2 regels** (*Ondertitelregels*, standaard 2). Is de cue langer, dan wordt er gewoon een nieuwe regel onder gezet en **schuift de tekst tijdens het uitspreken regel voor regel omhoog** — de bovenste regel verdwijnt, precies zoals bij YouTube's auto-generated ondertitels. Het font krimpt **nooit**; YouTube's eigen regelovergangen worden als spatie behandeld;
