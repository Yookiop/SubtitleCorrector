...
const BOOL_FIELDS = [
  'enabled', 'hotkeyEnabled', 'hotkeyToggleSubtitles', 'autoApply', 'preferAutoGenerated', 'forceSubtitlesOn', 'respectUserOff',
...
function collect() {
  ...
  // Een leeg hotkey-veld is een geldige keuze: dan staat de hotkey uit.
