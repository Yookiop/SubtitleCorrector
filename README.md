...
| Ondertitelgrootte (Caption Boost) | 125% | 50 - 250%. **100% = precies zo groot als YouTube's eigen ondertitels**; 125% is onze standaard. Stijl (kleur/achtergrond en de grove "Font size"-stand) volgt automatisch je YouTube-ondertitelinstellingen |
...
* de **grootte** stel je zelf in met *Ondertitelgrootte* (50 - 250%; standaard **125%**). **100% is precies zo groot als YouTube's eigen ondertitels** — wil je die look, zet hem dan op 100 (de optielijst stelt 75/100/125/150/175/200 voor);
