...
* **Positie**: met **Y-offset** schuif je de ondertitelbalk in de opties omhoog of omlaag (−40 tot +30 procentpunten van de spelerhoogte; standaard 7, dus iets hoger dan het uitgangspunt).
* **Lettertype & breedte**: kies in de opties het font (YouTube's eigen proportionele sans-serif, of leesfonts als Arial, Verdana, Segoe UI, Cambria, Georgia, Times New Roman en Palatino), de **letterdikte** (400-700; standaard 500) en de **breedte van de balk** (30-100%, standaard 70%). Voor precies YouTube's caption-look: font *Proportionele sans-serif*, dikte *400* en grootte *100%.
...
* **Hotkey uitzetten** (optie **Hotkey actief**, default aan): uit = de toets doet helemaal niets meer (geen correctie, geen toast) en de toets blijft gewoon naar de pagina gaan. Het hotkey-veld leegmaken werkt ook als "uit".
...
|-------|---------|-----------|
| Hotkey | `]` | Ook `ctrl+]` etc. mogelijk. Leeg laten = hotkey uit |
| Hotkey actief | aan | Uit = de hotkey doet helemaal niets meer: geen correctie, geen toast, en de toets gaat gewoon naar de pagina |
| Hotkey zet ondertitels aan/uit | uit | Modus van de hotkey (niet de aan/uit-schakelaar): aan = de hotkey wordt een schakelaar voor dít tabblad — 1e keer drukken = alles uit (captions, Caption Boost, bridge), nog een keer = weer aan + de gewone hotkey-logica (detecteren en de juiste track zetten) |
...
| Eigen ondertitelweergave (Caption Boost) | aan | Tekent de ondertitel zelf (standaard woord voor woord; zie Word-for-Word) en verbergt YouTube's eigen caption-venster zolang dat lukt |
...
| Ondertitelbreedte (Caption Boost) | 70% | Breedte van de ondertitelbalk als percentage van de spelerbreedte (30 - 100%). De balk staat gecentreerd, dus je houdt links en rechts altijd video zichtbaar. Lager = smaller |
...
| Y-offset (Caption Boost) | 7% | Verticale positie van de ondertitelbalk in procentpunten van de spelerhoogte: positief = omlaag, negatief = omhoog (bereik −40 tot +30). De balk blijft altijd binnen de speler |
...
* de **positie** stel je in met *Y-offset* (standaard **7**, bereik −40 tot +30): `L.captionBottomPct()` rekent dat om naar de afstand tot de onderrand (basis 10,5% van de spelerhoogte; positief = omlaag) en clamped op 0-80%, zodat de balk in de speler blijft;
...
* de **breedte** van de balk stel je in met *Ondertitelbreedte* (standaard **70%**, bereik 30 - 100%): `L.captionBarWidthPct()` rekent dat om, de balk wordt met `left`/`right` gecentreerd en de box krijgt dezelfde breedte — zo houd je links en rechts altijd video zichtbaar. Lager = smaller;
...
| Symptoom | Oplossing |
|----------|-----------|
| Er gebeurt niets bij `]` | Staat in de opties **Hotkey actief** aan en staat er een toets in het hotkey-veld? Heeft het YouTube-tabblad focus? Staat de extensie aan? Ververs het tabblad na het (her)laden van de extensie. |
| De hotkey doet nog iets terwijl ik hem uit wil | Zet in de opties **Hotkey actief** uit (of maak het hotkey-veld leeg). De optie *Hotkey zet ondertitels aan/uit* is iets anders: die kiest of de hotkey een aan/uit-schakelaar is of alleen een correctie forceert. |
